...
public class ActivityInjector {
    ...
    private final Map< Class <? extends Activity>, Provider<AndroidInjector.Factory< ? extends Activity>>> activityInjector;
    ...
    void inject(Activity activity){
        if(!(activity instanceof BaseActivity)){
            throw new IllegalArgumentException(activity.getClass().getSimpleName()+" must extend BaseActivity");
        ...
        AndroidInjector.Factory<Activity> injectorFactory =
                (AndroidInjector.Factory<Activity>) activityInjector.get(activity.getClass()).get();
